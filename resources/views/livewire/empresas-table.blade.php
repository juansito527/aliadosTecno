<div>
    <div class="w-full flex pb-10  p-2  shadow-md">
    ...
    <table class="table-auto w-full mb-6 shadow-lg mt-2">
        <thead>
        ...
        <tbody>
            @foreach($users as $user)
                <tr class="text-center ">
                    ...
                    <td><i class="fas fa-edit text-green-500 "></i><a href="#" class="mr-3 ml-3">editar</a> <i class="far fa-trash-alt   text-red-500"></i><a href="#" class="ml-3">eliminar</a></td>
