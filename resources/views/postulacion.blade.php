        ...
        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
          <div class="-mx-3 md:flex mb-6">
            <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input type="radio" name="1" value="gusta"> muñeño<br>
          ...
          <div class="-mx-3 md:flex mt-2">
            <div class="md:w-full px-3"> 
              <button type="button" class="md:w-full bg-gray-900 text-white font-bold py-2 px-4 border-b-4 hover:border-b-2 border-gray-500 hover:border-gray-100 rounded-full" onclick="plusSlides(2)">
                Continuar
              </button>
            </div>
          </div>
