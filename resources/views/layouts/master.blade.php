    ...
    <div class="max-w-6xl mx-auto px-4">
      <div class="flex justify-between">
        ...
        <div class="hidden md:flex items-center space-x-3 ">
          <a href="{{route('inicioSesion')}}" class="py-2 px-2 font-medium text-gray-500 rounded hover:bg-green-500 hover:text-white transition duration-300">Iniciar Sesion</a>
